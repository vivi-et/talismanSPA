					...
					<div class="col-12 col-md-3">
						<div class="_1adminOverveiw_card _box_shadow _border_radious _mar_b30 _1adminOverveiw_bg_one">
							<div class="_1adminOverveiw_card_left">
								...
								<p class="_1adminOverveiw_card_left_title">Today's Post</p>
							</div>
					...
					<div class="col-12 col-md-3">
						<div class="_1adminOverveiw_card _box_shadow _border_radious _mar_b30 _1adminOverveiw_bg_two">
							<div class="_1adminOverveiw_card_left">
								...
								<p class="_1adminOverveiw_card_left_title">Total Report</p>
							</div>
							<div class="_1adminOverveiw_card_right">
					...
					<div class="col-12 col-md-3">
						<div class="_1adminOverveiw_card _box_shadow _border_radious _mar_b30 _1adminOverveiw_bg_two">
							<div class="_1adminOverveiw_card_left">
								...
								<p class="_1adminOverveiw_card_left_title">Notice</p>
							</div>
							<div class="_1adminOverveiw_card_right">
								<Icon type="md-copy" />
							</div>
                    ...
                    <div class="col-12 col-md-3">
						<div class="_1adminOverveiw_card _box_shadow _border_radious _mar_b30 _1adminOverveiw_bg_two">
							<div class="_1adminOverveiw_card_left">
								...
								<p class="_1adminOverveiw_card_left_title">Card</p>
							</div>
							<div class="_1adminOverveiw_card_right">
								<Icon type="md-card" />
							</div>
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					...
					<div class="_overflow _table_div">
						<table class="_table">
							...
							<tr>
								<td>25-05-19</td>
								<td class="_table_name">who have experience in leather garment business</td>
								<td>people</td>
								<td>03</td>
								<td>
